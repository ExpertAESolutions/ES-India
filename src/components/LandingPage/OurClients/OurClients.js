        ...
        <div className={classes.Section}>
          ...
          <div className={classes.Content}>
            <img
              className={classes.Image}
              src={Client2}
              alt="Indian Institute of Technology, Roorkee, UK"
            />
          </div>
          <div className={classes.Content}>
            <img
          ...
          <div className={classes.Content}>
            <img
              className={classes.Image}
              src={Iti}
              alt="Indian Telephone Industries, UP"
            />
          </div>
          <div className={classes.Content}>
            <img
              className={classes.Image}
              src={ITC}
              alt="International Tobacco Company, Ghaziabad, UP"
            />
          </div>
        ...
        <div className={classes.Section}>
          <div className={classes.Content}>
            <img
              className={classes.Image}
              src={KK}
              alt="KK Modi University, Durg, Chhattisgarh"
            />
          </div>
          <div className={classes.Content}>
            <img
              className={classes.Image}
              src={MNNIT}
              alt="Motilal Nehru National Institute of Technology, Prayagraj, UP"
            />
          </div>
          <div className={classes.Content}>
            <img
              className={classes.Image}
              src={PEDVAK}
              alt="Pedvak Technologies Pvt. Ltd, Hyderabad, Telangana"
            />
          </div>
          <div className={classes.Content}>
            <img
              className={classes.Image}
              src={Pwd}
              alt="Public Works Department, New Delhi"
            />
          </div>
          <div className={classes.Content}>
            <img
              className={classes.Image}
              src={BANK}
              alt="Reserve Bank of India, Kanpur, UP"
            />
          </div>
        </div>{" "}
        <div className={classes.Section}>
          <div className={classes.Content}>
            <img
              className={classes.Image}
              src={Ryan}
              alt="Ryan Group of Schools, NCR-Delhi"
            />
          </div>
          <div className={classes.Content}>
            <img
              className={classes.Image}
              src={SamIndia}
              alt="SAM India Built Well Pvt. Ltd., Anand Vihar, New Delhi"
            />
          </div>
          <div className={classes.Content}>
            <img
              className={classes.Image}
              src={PT}
              alt="Tala Hydro-electric Project, Bhutan"
            />
          </div>
          <div className={classes.Content}>
            <img
        ...
        <div className={classes.Section}>
          <div className={classes.Content}>
            <img
              className={classes.Image}
              src={UPBC}
              alt="UP State Bridge Corporation"
            />
          </div>
          <div className={classes.Content}>
            <img
              className={classes.Image}
              src={ELEC}
              alt="UP State Electricity Board "
            />
          </div>
        </div>{" "}
      </div>
